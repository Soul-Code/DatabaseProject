  ...
  <div>
    <el-container>
      ...
      <el-main>
        ...
        <el-table :data="tableData" style="width: 100%" v-if="form==='2'">
          <el-table-column prop="date" label="课程号" width="180"></el-table-column>
          <el-table-column prop="name" label="课程名" width="180"></el-table-column>
          <el-table-column prop="address" label="成绩"></el-table-column>
        </el-table>

        <el-form ref="form" :model="form" label-width="80px" v-if="form==='3'">
          <el-row>
            <el-col :span="10">
        ...
        <el-form ref="form" :model="form" label-width="80px" v-if="form==='4'">
          <el-row>
            <el-col :span="10">
        ...
        <el-table :data="tableData" style="width: 100%" v-if="form==='4'">
          <el-table-column prop="date" label="备注" width="50"></el-table-column>
          <el-table-column prop="date" label="课程号" width="100"></el-table-column>
          <el-table-column prop="name" label="课程名" width="100"></el-table-column>
          <el-table-column prop="name" label="学分" width="100"></el-table-column>
          <el-table-column prop="name" label="开课系" width="100"></el-table-column>
          <el-table-column prop="address" label="任课教师"></el-table-column>
        </el-table>
      </el-main>
    </el-container>
  </div>
